...
TradingBrain V10 是一套以 **市場結構、K 線確認、分層風控與研究型 logging** 為核心的加密貨幣交易系統，主要用於 Binance Testnet / Demo 觀察、策略迭代與交易研究。
